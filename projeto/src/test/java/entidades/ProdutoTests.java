...
import org.junit.jupiter.api.Assertions; // Importe o Assertions
...
public class ProdutoTests {
    ...
    public void testBuscaCategoriaBuscaUmFabricanteSalvaUmProduto() {
        ...
        Assertions.assertNotNull(produto.codigo);

        Assertions.assertEquals("Macarrão Espaguete 500Gm", produto.nome);
        Assertions.assertEquals("Massas", produto.categoria.nome);
    }
}